...
Puppet::Indirector::Face.define(:package, '0.0.1') do
  ...
  save = get_action(:save).summary "Invalid for this face."
  get_action(:search).summary "Invalid for this face."

  destroy = get_action(:destroy)
  destroy.summary "Uninstall a package object"
  destroy.arguments "<package name>"
  destroy.returns "A transaction report object"

  find = get_action(:find)
  find.summary "API only: Retrive a package object"
  find.arguments "<package name>"
  find.returns "A package object"
